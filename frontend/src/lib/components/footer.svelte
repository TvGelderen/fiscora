	...
	<div class="container mx-auto px-4">
		<div class="flex flex-wrap items-start justify-between">
			<div class="mb-6 w-full md:mb-0 md:w-1/3">
				<h3 class="mb-2 text-2xl">Fiscora</h3>
				<p>
					Empowering your financial journey, one transaction at a
					time.
				</p>
			</div>
			<div class="mb-6 w-full md:mb-0 md:w-1/4">
				<h4 class="mb-2 text-2xl">Features</h4>
				<ul class="space-y-2">
					<li>
			...
			<div class="w-full md:w-1/6">
				<h4 class="mb-2 text-2xl">Connect</h4>
		...
		<div
			class="mt-8 border-t border-primary-500/50 pt-8 text-center text-sm text-indigo-900 dark:text-indigo-300"
		>
